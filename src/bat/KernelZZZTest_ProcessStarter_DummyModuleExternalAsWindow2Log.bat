...
start "fglProcessCreateMainZZZ" java -cp C:\HIS-Workspace\1fgl\repo\EclipseOxygen\Projekt_Kernel02_JAZModuleExternal\src\bat\JAZModuleExternalDummy.jar debug.zBasic.util.moduleExternal.process.createDummy.ProcessCreateMockDummyMainZZZ > c:\fglkernel\kernellog\ProcessCreate_StarterLog.txt
pause