...
REM start "fglProcessCreateMainZZZ" java -cp C:\1fgl\client\JAZKernel\JAZModuleExternalDummy.jar debug.zBasic.util.moduleExternal.process.createDummy.ProcessCreateMockDummyMainZZZ > c:\fglkernel\kernellog\ProcessCreate_StarterLog.txt
REM auf dem Notebook der TUBAF start "fglProcessCreateMainZZZ" java -cp C:\HIS-Workspace\1fgl\repo\EclipseOxygen\Projekt_Kernel02_JAZModuleExternal\src\bat\JAZModuleExternalDummy.jar debug.zBasic.util.moduleExternal.process.createDummy.ProcessCreateMockDummyMainZZZ > c:\fglkernel\kernellog\ProcessCreate_StarterLog.txt
start "fglProcessCreateMainZZZ" java -cp C:\1fgl\repo\EclipseOxygen_V01\Projekt_Kernel02_JAZModuleExternal\src\bat\JAZModuleExternalDummy.jar debug.zBasic.util.moduleExternal.process.createDummy.ProcessCreateMockDummyMainZZZ > c:\fglkernel\kernellog\ProcessCreate_StarterLog.txt
pause